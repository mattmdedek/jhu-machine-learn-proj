...
# Split the training data into a training set (70%) and a probe set (70%)
# The probe set will be used to test accuracy.
...
I use the 'gbm' method of the caret package to Bagging with trees. Caret builds in cross-validation.
...
Since this model takes a long time to build (about 30 minutes), I saved it for future use. The code used to generate the model is shown here, the defaults were used.
...
As mentioned above, the a probe dataset was set aside to test the accuracy of the model. Here I use the predict function to predict the 'classe' of each exercise in the probe data set and compare the prediction to the expected value.
...
This code was used to create the files for the Submission part of the course project.
